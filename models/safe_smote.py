...
class SafeSMOTE(BaseEstimator):
    ...
    SMOTENC is imported lazily inside fit_resample() so that loading a
    serialized (joblib) pipeline for inference does not require
    imbalanced-learn to be installed or version-compatible.
    """
    ...
    def fit_resample(self, X, y):
        from imblearn.over_sampling import SMOTENC  # lazy: only needed at training time
